...
import { newUserPermissionformSchema } from "~/validations/newUserPermissionformSchema";
import { ref } from "vue";
...
const form = useForm({
  validationSchema: newUserPermissionformSchema,
});
...
<template>
  <div class="w-full flex flex-col gap-8">
    <div class="pb-4">
      <h1 class="md:text-2xl text-lg font-medium">Add User Permission</h1>
      <p class="text-sm text-muted-foreground">Create new user permissions</p>
    </div>
            ...
            <FormField v-slot="{ componentField }" name="permissionName">
              <FormItem>
                ...
                <FormControl>
                  <UiInput
                    type="text"
                    placeholder="Enter Customer Permission Name"
