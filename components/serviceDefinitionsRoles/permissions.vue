    ...
    <UiAlertDialogContent>
      <UiAlertDialogHeader>
        ...
        <UiAlertDialogDescription>
          This action cannot be undone. This will permanently remove permissions from this service definition role, inherited contracts, core customers, accounts and contract users.
        </UiAlertDialogDescription>
      </UiAlertDialogHeader>
      <UiAlertDialogFooter>
  ...
  <UiAlertDialog :open="openAddPermissionModal" :onOpenChange="setOpenAddPermissionModal">
    <UiAlertDialogContent>
      <UiAlertDialogHeader>
        <UiAlertDialogTitle>Are you absolutely sure?</UiAlertDialogTitle>
        <UiAlertDialogDescription>
          This action cannot be undone. This will permanently add permissions for thise service definition role, inherited contracts, core customers, accounts and contract users.
        </UiAlertDialogDescription>
      </UiAlertDialogHeader>
      <UiAlertDialogFooter>
