...
const { getContractPermissions } = useContracts();
...
const fetchContractPermissionsData = async () => {
  try {
...
const fetchContractCoreCustomerPermissions = async () => {
  try {
    isLoading.value = true;
    loading.value = true;
    const response = await getContractCoreCustomerPermissions(
      coreCustomerId.value
    );
...
onMounted(async () => {
  await fetchContractPermissionsData();
...
const addSelectedPermissions = async () => {
  ...
  try {
    ...
    await createContractCoreCustomerPermission(coreCustomerId.value, {
...
const deleteSelectedPermissions = async () => {
  ...
  try {
    ...
    isSubmitting.value = true;
    await deleteContractCoreCustomerPermission(coreCustomerId.value, {
    ...
    <UiAlertDialogContent>
      <UiAlertDialogHeader>
        ...
        <UiAlertDialogDescription>
          This action cannot be undone. This will permanently remove permissions from this core customers, inherited accounts and contract users.
        </UiAlertDialogDescription>
      </UiAlertDialogHeader>
      <UiAlertDialogFooter>
  ...
  <UiAlertDialog :open="openAddPermissionModal" :onOpenChange="setOpenAddPermissionModal">
    <UiAlertDialogContent>
      <UiAlertDialogHeader>
        <UiAlertDialogTitle>Are you absolutely sure?</UiAlertDialogTitle>
        <UiAlertDialogDescription>
          This action cannot be undone. This will permanently add permissions for this core customers, inherited accounts and contract users.
        </UiAlertDialogDescription>
      </UiAlertDialogHeader>
      <UiAlertDialogFooter>
