    ...
    <UiAlertDialogContent>
      <UiAlertDialogHeader>
        ...
        <UiAlertDialogDescription>
          This action cannot be undone. This will permanently remove permissions from service definitions, contracts, core customers, accounts and contract users.
        </UiAlertDialogDescription>
      </UiAlertDialogHeader>
      <UiAlertDialogFooter>
  ...
  <UiAlertDialog :open="openAddPermissionModal" :onOpenChange="setOpenAddPermissionModal">
    <UiAlertDialogContent>
      <UiAlertDialogHeader>
        <UiAlertDialogTitle>Are you absolutely sure?</UiAlertDialogTitle>
        <UiAlertDialogDescription>
          This action cannot be undone. This will permanently add permissions for service definitions, contracts, core customers, accounts and contract users.
        </UiAlertDialogDescription>
      </UiAlertDialogHeader>
      <UiAlertDialogFooter>
