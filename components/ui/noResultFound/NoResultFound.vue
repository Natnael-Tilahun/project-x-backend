...
<template>
  <div
    class="{`w-full h-60 md:h-[500px] p-10 bg-[#f7effc] dark:bg-thm_dark_background rounded-lg border-none shadow-none max-h-screen flex flex-col gap-2 justify-center items-center ${className}`}"
  >
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="currentColor"
      class="w-32 pb-4 fill-thm_secondary_color"
    >
      <path
    ...
    <h1 class="font-medium lg:text-xl dark:text-thm_dark_primary_color">
      {{ props.title ? props.title : "Sorry, No result found" }}
    </h1>
    <p
