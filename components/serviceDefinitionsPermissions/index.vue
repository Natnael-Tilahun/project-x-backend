      ...
      <div class="flex gap-8 h-full w-full">
        ...
        <div class="w-full h-full flex flex-col">
          ...
          <div class="flex items-center gap-2 mb-2">
            ...
            <UiPermissionGuard :permission="PermissionConstants.ADD_SERVICE_DEFINITION_PERMISSION">
            <UiButton
        ...
        <div class="w-full min-h-min flex flex-col">
          ...
          <div class="flex items-center gap-2 mb-2">
            ...
            <UiPermissionGuard :permission="PermissionConstants.REMOVE_SERVICE_DEFINITION_PERMISSION">
            <UiButton
              size="sm"
